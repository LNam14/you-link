...
export default function SpinLucky({ title = "Vòng Quay May Mắn" }) {
  ...
  // Enhanced prize data with beautiful gradient colors
  const data = [
    { option: "1 phân vàng", style: { backgroundColor: "#FFD700", textColor: "black" } }, // 0
    { option: "1 lời chúc may mắn", style: { backgroundColor: "#FF6B35", textColor: "white" } }, // 1
    { option: "Quay thêm 1 lượt", style: { backgroundColor: "#8B5CF6", textColor: "white" } }, // 2
    { option: "50.000 VND", style: { backgroundColor: "#EF4444", textColor: "white" } }, // 3
    { option: "1 phân vàng", style: { backgroundColor: "#FFD700", textColor: "black" } }, // 4
    { option: "20.000 VND", style: { backgroundColor: "#3B82F6", textColor: "white" } }, // 5
    { option: "10.000 VND", style: { backgroundColor: "#06B6D4", textColor: "white" } }, // 6
    { option: "1 phân vàng", style: { backgroundColor: "#FFD700", textColor: "black" } }, // 7
    { option: "5.000 VND", style: { backgroundColor: "#F59E0B", textColor: "white" } }, // 8
    { option: "2.000 VND", style: { backgroundColor: "#10B981", textColor: "white" } }, // 9
  ]
