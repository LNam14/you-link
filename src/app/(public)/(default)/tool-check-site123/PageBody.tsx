                ...
                <HotTable
                    ...
                    contextMenu={{
                        items: {
                            copy: {
                                name: "Copy",
                                callback: function (key: string, selection: any[], clickEvent: Event) {
                                    this.copyPaste.copy()
                                },
                            },
                            copy_with_headers: {
                    ...
                    beforeKeyDown={(event: KeyboardEvent) => {
                        ...
                        if (event.ctrlKey && event.key === "c") {
                            ...
                            const hot = event.target as any
                            if (hot.hotInstance) {
                                hot.hotInstance.getPlugin("copyPaste").copy()
                            }
                            return false
                        }
